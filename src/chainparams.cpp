...
// Copyright (c) 2023 The Sciia developers
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 1 * 60; // Raptoreum: 2 minutes
        ...
        vSeeds.emplace_back("node.sciprotocol.org");
        vSeeds.emplace_back("node1.sciprotocol.org");
	vSeeds.emplace_back("node2.sciprotocol.org");
	vSeeds.emplace_back("node3.sciprotocol.org");
	vSeeds.emplace_back("node4.sciprotocol.org");
	vSeeds.emplace_back("node5.sciprotocol.org");
	vSeeds.emplace_back("node6.sciprotocol.org");
	vSeeds.emplace_back("node7.sciprotocol.org");
	vSeeds.emplace_back("node8.sciprotocol.org");
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 15} };// 15% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 1,"1GPr7Fg1Gjt8f6ykC8dqTVHuqv7YbJX8mX");
        ...
        vSporkAddresses = {"1GPr7Fg1Gjt8f6ykC8dqTVHuqv7YbJX8mX"};
        nMinSporkKeys = 1;
