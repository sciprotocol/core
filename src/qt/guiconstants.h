...
/* SciiaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* SciiaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Sciia"
#define QAPP_ORG_DOMAIN "sciprotocol.org"
#define QAPP_APP_NAME_DEFAULT "Sciia-Qt"
#define QAPP_APP_NAME_TESTNET "Sciia-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Sciia-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Sciia-Qt-regtest"
