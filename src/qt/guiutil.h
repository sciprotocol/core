...
/** Utility functions used by the Sciia Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sciia:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load sciia specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a sciia specific theme is activated (light/dark).*/
