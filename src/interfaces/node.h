...
//! Interface for the src/evo part of a sciia node (sciiad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a sciia node (sciiad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a sciia node (sciiad process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a sciia node (sciiad process).
class Node
{
public:
    virtual ~Node() {}
