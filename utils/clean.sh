...
rm -f src/config/sciia-config.h
...
rm -rf test_bitcoin.coverage/ sciia-gtest.coverage/ total.coverage/
...
clean_exe src/sciia-cli
clean_exe src/sciiad
clean_exe src/sciia-gtest
clean_exe src/sciia-tx
clean_exe src/test/test_sciia
clean_exe src/test/test_sciia_fuzzy
...
clean_dep . src/config/sciia-config.h.in
