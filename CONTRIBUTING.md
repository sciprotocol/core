Contributing to Sciia Core
============================

The Sciia Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sciiachain/sciia/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Sciia Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Sciia
Network Protocol consensus changes.

Whether a pull request is merged into Sciia Core rests with the project merge
...
Patches that change Sciia consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sciia consensus, it must have been
...
The review process is normally fairly responsive on the Sciia Core repository, however
...
The project leader is the release manager for each Sciia Core release.
