...
from test_framework.test_framework import SciiaTestFramework
...
class LLMQChainLocksTest(SciiaTestFramework):
    def set_test_params(self):
        self.set_sciia_test_params(6, 5, fast_dip3_enforcement=True)
