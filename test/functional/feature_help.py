...
"""Verify that starting sciiad with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sciiad with -h for help text")
        ...
        self.log.info("Start sciiad with -version for version information")
