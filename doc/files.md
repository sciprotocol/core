...
* sciia.conf: contains configuration settings for sciiad or sciia-qt
* sciiad.pid: stores the process id of sciiad while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by sciiad or sciia-qt
