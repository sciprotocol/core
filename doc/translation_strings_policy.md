...
This document provides guidelines for internationalization of the Sciia Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sciia_en.ts` remains unchanged.
